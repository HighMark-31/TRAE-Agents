...
- **Name** – The title of the agent.  
- **Applicable scenarios** – The specific use cases, tasks, or workflows where this agent can be applied.
...
This iterative process ensured that each prompt was precise, context-aware, and aligned with the agent’s intended behavior.
